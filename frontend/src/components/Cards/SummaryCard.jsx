...
const SummaryCard = ({
  ...
  return   <div
      className="bg-white border border-gray-400/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-200 relative group"
      onClick={onSelect}
    >
      <div
      ...
      <div className="px-3 pb-3">
        <div className="flex items-center gap-3 mt-4">
          <div className="text-[11px] font-bold text-black px-3 py-1 border-[0.5px]  border-black rounded-full">
        ...
        {/* Description */}
        <p className="text-[12px] text-gray-500 font-bold line-clamp-2 mt-3">
          {description}
        </p>
      </div>
    </div>
