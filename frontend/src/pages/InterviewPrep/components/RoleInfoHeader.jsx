  ...
  return (
    <div className="bg-white relative">
      <div className="container mx-auto px-10 md:px-0">
        ...
        {/* Blurred blobs - hidden on mobile */}
        <div className="hidden md:flex w-[40vw] md:w-[30vw] h-[200px] items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
